...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icons/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icons/icon4.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("icons/icon14.jpg"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("icons/icon15.png"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("icons/icon15.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("icons/icon14.jpg"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("icons/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("icons/icon17.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icons/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("icons/icon6.png"));
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("icons/icon7.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("icons/icon8.png"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("icons/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("icons/icon10.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icons/icon11.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("icons/icon12.png"));
