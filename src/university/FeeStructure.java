...
public class FeeStructure extends JFrame{
    ...
    public FeeStructure(){
        ...
        m1.setFont(new Font("serif",Font.PLAIN,25));
        add(m1);
        
        m2 = new JLabel("Rs 65000");
        m2.setBounds(1080,240,150,40);
        m2.setFont(new Font("serif",Font.PLAIN,25));
        add(m2);
        
        m3 = new JLabel("Rs 65000");
        m3.setBounds(1080,310,150,40);
        m3.setFont(new Font("serif",Font.PLAIN,25));
        add(m3);
        
        m4 = new JLabel("Rs 65000");
        m4.setBounds(1080,380,150,40);
        m4.setFont(new Font("serif",Font.PLAIN,25));
        add(m4);
        ...
        m5.setFont(new Font("serif",Font.PLAIN,25));
        add(m5);
        
        m6 = new JLabel("Rs 55000");
        m6.setBounds(1280,240,150,40);
        m6.setFont(new Font("serif",Font.PLAIN,25));
        add(m6);
        
        m7 = new JLabel("Rs 55000");
        m7.setBounds(1280,310,150,40);
        m7.setFont(new Font("serif",Font.PLAIN,25));
        add(m7);
        
        m8 = new JLabel("Rs 55000");
        m8.setBounds(1280,380,150,40);
        m8.setFont(new Font("serif",Font.PLAIN,25));
        add(m8);
        ...
        m9.setFont(new Font("serif",Font.PLAIN,25));
        add(m9);
        
        m10 = new JLabel("Rs 81000");
        m10.setBounds(1480,240,150,40);
        m10.setFont(new Font("serif",Font.PLAIN,25));
        add(m10);
        
        m11 = new JLabel("Rs 81000");
        m11.setBounds(1480,310,150,40);
        m11.setFont(new Font("serif",Font.PLAIN,25));
        add(m11);
        
        m12 = new JLabel("Rs 81000");
        m12.setBounds(1480,380,150,40);
        m12.setFont(new Font("serif",Font.PLAIN,25));
        add(m12);
        ...
        l17.setFont(new Font("serif",Font.BOLD,25));
        add(l17);
